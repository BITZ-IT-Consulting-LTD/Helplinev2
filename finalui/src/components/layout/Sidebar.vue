<template>
  <aside class="fixed left-0 top-0 h-screen w-64 bg-gray-800 border-r border-gray-700 flex flex-col shadow-xl">
    ...
    <nav class="flex-1 overflow-y-auto px-6 py-2">
      <div class="flex flex-col gap-1.5 text-gray-300">
